# Normative Binary Specification: Impulse Graph Format (v2.3.0)
...
This document is automatically generated from the normative specification schema `v2.3.yaml`.
...
| `sha256` | `uint8[32]` | Cryptographic SHA-256 checksum |
